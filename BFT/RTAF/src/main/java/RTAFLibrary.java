...
/**
 * RTAFLibrary is a ... library for the Robot Framework.<br>
 * <br>
 * <b>Insert library introduction here.</b>
 */
public class RTAFLibrary extends AnnotationLibrary {
	 ...
	 */
	public static final Javadoc2Libdoc JAVADOC_2_LIBDOC = new Javadoc2Libdoc(RTAFLibrary.class);
	...
	private static String loadRobotLibraryVersion() {
		try {
			return ResourceBundle.getBundle(RTAFLibrary.class.getCanonicalName().replace(".", File.separator))
					.getString("version");
	...
	/**
	 * RTAFLibrary can be imported with optional arguments.<br>
	 * <br>
